...
BufferDesc *ioBufHdrs[BLOCK_COUNT];
BlockNumber ioBlockNumbers[BLOCK_COUNT];
Buffer *ioBufs[BLOCK_COUNT];
Block ioBlocks[BLOCK_COUNT];
int ioBlockToeElemIndexMap[BLOCK_COUNT];
int ioBlockIndexMap[BLOCK_COUNT];
